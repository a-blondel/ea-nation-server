...
CREATE TABLE IF NOT EXISTS core.BLACKLIST (
    ID bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS core.PERSONA (
    ...
    CONSTRAINT FK_PERSONA_ACCOUNT_ID FOREIGN KEY (ACCOUNT_ID) REFERENCES core.ACCOUNT(ID)
);

CREATE TABLE IF NOT EXISTS stats.MOHH_PERSONA_STATS (
    ID bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
    ...
    CONSTRAINT FK_MOHH_PERSONA_STATS_PERSONA_ID FOREIGN KEY (PERSONA_ID) REFERENCES core.PERSONA(ID)
);

CREATE TABLE IF NOT EXISTS core.PERSONA_CONNECTION (
    ID bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
    PERSONA_ID bigint NOT NULL,
    ...
    END_TIME timestamp,
    CONSTRAINT FK_PERSONA_CONNECTION_PERSONA_ID FOREIGN KEY (PERSONA_ID) REFERENCES core.PERSONA(ID)
);
...
CREATE TABLE IF NOT EXISTS core.GAME_CONNECTION (
    ID bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
    ...
    START_TIME timestamp NOT NULL,
    END_TIME timestamp,
    CONSTRAINT FK_GAME_CONNECTION_GAME_ID FOREIGN KEY (GAME_ID) REFERENCES core.GAME(ID),
    CONSTRAINT FK_GAME_CONNECTION_PERSONA_CONNECTION_ID FOREIGN KEY (PERSONA_CONNECTION_ID) REFERENCES core.PERSONA_CONNECTION(ID)
);

CREATE TABLE IF NOT EXISTS stats.MOHH_GAME_REPORT (
    ...
    START_TIME timestamp NOT NULL,
    END_TIME timestamp,
    CONSTRAINT FK_MOHH_GAME_REPORT_GAME_CONNECTION_ID FOREIGN KEY (GAME_CONNECTION_ID) REFERENCES core.GAME_CONNECTION(ID)
);
...
CREATE TABLE IF NOT EXISTS discord.CHANNEL_SUBSCRIPTION (
    ...
    CONSTRAINT channel_subscription_guild_id_subscription_type_game_genre_key UNIQUE (guild_id, subscription_type, game_genre)
);
